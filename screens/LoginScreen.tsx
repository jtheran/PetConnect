...
const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin }) => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-100 to-orange-200 flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-sm mx-auto bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl overflow-hidden md:max-w-4xl md:grid md:grid-cols-2">
        {/* Image Panel - Visible on medium screens and up */}
        <div className="hidden md:block">
            <img 
                src="https://picsum.photos/seed/petlogin/800/1200" 
                alt="A happy pet" 
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center">
            <div className="text-center">
                ...
                <h1 className="text-4xl md:text-5xl font-extrabold text-orange-600 drop-shadow-sm">PetConnect</h1>
